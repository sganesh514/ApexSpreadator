"""
ApexSpreadator — Broker Abstraction Layer
Abstract base class for broker implementations.
Allows easy swapping between IBKR, paper trading, etc.
"""
...
class BrokerBase(ABC):
    ...
    Implement this class for each broker platform:
    - IBKRBroker (Interactive Brokers) — primary
    """
